...
public class TokenProvider {
    ...
    public void init() {
        byte[] keyBytes;
        String secret = ieProperties.getSecurity().getSecret();
        if (!StringUtils.isEmpty(secret)) {
            ...
            keyBytes = Decoders.BASE64.decode(ieProperties.getSecurity().getBase64Secret());
        }
        this.key = Keys.hmacShaKeyFor(keyBytes);
        this.tokenValidityInMilliseconds =
            1000 * ieProperties.getSecurity().getTokenValidityInSeconds();
        this.tokenValidityInMillisecondsForRememberMe =
            1000 * ieProperties.getSecurity().getTokenValidityInSecondsForRememberMe();
    }
